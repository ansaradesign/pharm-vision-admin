...
export const DashboardHeader = ({ amount, dateRange, onChangeDateRange }: Props) => {
  return (
    <Flex col gap={6}>
      <Text opacity={0.5}>Здесь вы можете посмотреть общую статистику по всем компаниям.</Text>
      <Flex>
        <Flex>
